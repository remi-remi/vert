...
public Box(int id, float superficie, String libelle, int idPension, float tarif) {
	this.id = id;
...
public Box(int id, float superficie, String libelle, float tarif) {
	this.id = id;
	this.superficie = superficie;
	this.libelle = libelle;
	this.tarif=tarif;
...
public Box(String libelle, int idPension, float superficie) {
	this.id = 0;
	this.superficie = superficie;
	this.libelle = libelle;
	this.idPension= idPension;
